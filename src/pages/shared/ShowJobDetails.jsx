...
const ShowJobDetails = ({job}) => {
    ...
    return (
        <div className='my-8 mx-2'>
            ...
            {/* apply now button */}
            {routelocation.pathname === `/postedJobDetails/${_id}` 
            ? <Link to={`/applications/jobs/${_id}`} className='btn bg-first text-white font-bold my-6 w-full'>View Application List</Link> 
